...
The current folder `Results` only contains the results of the parameter exploration, and it is necessary to reproduce figure 6 and r values.

### Figures

Contains the figures used in the paper. These can be generated again using the script `05_Plots_Results.R`.
...
`04_Sensitivity.R`
Calculations to explore the parameter space.
